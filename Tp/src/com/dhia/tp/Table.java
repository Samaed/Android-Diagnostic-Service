...
public static void createm(){
	...
	List<String> lisiHyperthyro�die = new ArrayList<String>();
	lisiHyperthyro�die.add("body temperature ");
	lisiHyperthyro�die.add("oxygenation of blood");
	lisiHyperthyro�die.add("pulse rate");
	
	
	 mapm.put("Diabete",lisdia );
	 mapm.put("inflammation",lisfla );
	 mapm.put("infection",lisinfix );
	 mapm.put("Hyperthyro�die",lisiHyperthyro�die);
